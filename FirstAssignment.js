...
let compose = author + " once said, " + quote;
console.log(compose);
/*
...
*/
let names = ["Huzaifa", "Moiz", "Shuja", "Faraz", "Bilal"];
...
*/
let guestList = ["Huzaifa", "Moiz", "Faraz"];
...
*/
let guestWhoCantAttend = "Moiz";
let replacementGuest = "Shuja";
